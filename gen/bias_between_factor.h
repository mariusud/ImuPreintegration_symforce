 ...
 *     jacobian: (3x6) jacobian of res wrt args value (3), prior (3)
 *     hessian: (6x6) Gauss-Newton hessian for args value (3), prior (3)
 *     rhs: (6x1) Gauss-Newton rhs for args value (3), prior (3)
 */
...
void BiasBetweenFactor(const Eigen::Matrix<Scalar, 3, 1>& diag_sqrt_info, const Scalar time_delta,
  ...
  const Scalar _tmp3 = prior(1, 0) - value(1, 0);
  const Scalar _tmp4 = _tmp1 * diag_sqrt_info(1, 0);
  const Scalar _tmp5 = prior(2, 0) - value(2, 0);
